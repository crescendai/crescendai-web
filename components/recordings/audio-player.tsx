// app/recordings/[id]/components/audio-player.tsx
"use client"
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        >
          <div
            className="absolute top-0 left-0 h-full bg-[#0471A6] rounded-full transition-all duration-150"
            style={{ width: `${progressPercentage}%` }}
          />
          <div
            className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-[#0471A6] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-150"
      ...
      <div className="flex items-center justify-between">
          ...
          {speedOptions.map((speed) => (
            <Button
              ...
              className={cn(
                ...
                playbackSpeed === speed ? "bg-[#0471A6]/20 text-[#0471A6]" : "text-gray-600 hover:text-gray-900",
              )}
            >
              {speed}x
            </Button>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="w-10 h-10 rounded-full bg-[#0471A6] hover:bg-[#0471A6]/90 text-white"
          >
