  ...
  return (
    <TooltipProvider>
      <div className="space-y-4">
        {/* Timeline Container */}
        <div
          className="relative h-16 bg-muted/30 rounded-lg cursor-pointer group overflow-hidden"
        ...
        >
          ...
          <div
            className="absolute top-0 w-0.5 h-full bg-primary transition-all duration-150"
            ...
            return (
              <Tooltip key={marker.timestamp}>
                <TooltipTrigger asChild>
                  <button
                    className={cn(
                      "absolute top-1/2 -translate-y-1/2 w-4 h-4 rounded-full border-2 border-background transition-all duration-200 hover:scale-125 focus:scale-125 focus:outline-none focus:ring-2 focus:ring-ring",
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div className="space-y-1">
            <div className="text-2xl font-bold text-accent">{markers.length}</div>
